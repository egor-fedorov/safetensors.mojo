...
def main() -> int:
    ...
    run(
        [sys.executable, "tools/checks/check_format.py"],
    ...
    run(
        [
            ...
            str(
                ...
                / "packaging"
                / "consumers"
                / "package_smoke_format_core.mojo"
            ),
        ],
    ...
    run(
        [sys.executable, "tools/checks/run_mojo_tests.py"],
        "Run Mojo tests",
        environment,
    )
